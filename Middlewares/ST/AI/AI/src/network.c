...
#define AI_NETWORK_MODEL_SIGNATURE     "03bd25e15ee5dc9b8dbcb8c850dcba01"
...
#define AI_TOOLS_DATE_TIME   "Wed Jun 26 14:03:22 2019"
...
AI_TENSOR_OBJ_DECLARE(
  conv2d_1_output_in,
  AI_SHAPE_INIT(3, 3, 24, 1),
  AI_STRIDE_INIT(288, 96, 4, 4),
  &conv2d_1_output_in_array,
  AI_STATIC)
AI_TENSOR_OBJ_DECLARE(
  conv2d_1_output_out,
  AI_SHAPE_INIT(1, 1, 216, 1),
  AI_STRIDE_INIT(864, 864, 4, 4),
...
AI_TENSOR_OBJ_DECLARE(
  dense_1_weights,
  AI_SHAPE_INIT(1, 1, 12, 216),
  AI_STRIDE_INIT(10368, 10368, 864, 4),
...
AI_TENSOR_OBJ_DECLARE(
  dense_2_weights,
  AI_SHAPE_INIT(1, 1, 5, 12),
  AI_STRIDE_INIT(240, 240, 48, 4),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
  ...
  dense_1_output_array.data = activations + 1728;
  dense_1_output_array.data_start = activations + 1728;
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
  ...
  conv2d_1_bias_array.data = weights + 1536;
  conv2d_1_bias_array.data_start = weights + 1536;
  dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
  dense_1_weights_array.data = weights + 1632;
  dense_1_weights_array.data_start = weights + 1632;
  dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
  dense_1_bias_array.data = weights + 12000;
  dense_1_bias_array.data_start = weights + 12000;
  dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
  dense_2_weights_array.data = weights + 12048;
  dense_2_weights_array.data_start = weights + 12048;
  dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
  dense_2_bias_array.data = weights + 12288;
  dense_2_bias_array.data_start = weights + 12288;
